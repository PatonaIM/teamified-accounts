...
export const COLORS = ['#A16AE8', '#6366F1', '#22C55E', '#F59E0B', '#EF4444', '#06B6D4', '#8B5CF6', '#EC4899'];
...
export function StatCard({ title, value, subtitle, icon, color = '#A16AE8' }: { title: string; value: string | number; subtitle?: string; icon: React.ReactNode; color?: string }) {
  return (
...
export function ReportPageLayout({ title, children }: ReportPageLayoutProps) {
...
export function LoginTrafficContent() {
...
export function OrgHealthContent() {
...
export function StickinessContent() {
...
export function TimeToValueContent() {
