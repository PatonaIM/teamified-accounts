...
export default function ReleaseNote_2025_12_03_v103() {
        ...
        <Stack spacing={4}>
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              This release introduces a comprehensive OAuth Configuration management interface within Admin Tools, 
          ...
          <Box>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 2 }}>
              <Edit color="primary" />
              <Typography variant="h6" sx={{ fontWeight: 600 }}>
                2. Enhanced Redirect URI Management
              </Typography>
            </Stack>
            <Typography variant="body1" paragraph>
          ...
          <Box>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 2 }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 600 }}>
                4. Safe Deletion with Soft Delete
              </Typography>
            </Stack>
            <Typography variant="body1" paragraph>
