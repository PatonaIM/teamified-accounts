...
const UnifiedThemeEditorPage: React.FC = () => {
  ...
  const updateTypographyVariant = (variant: string, property: string, value: string | number) => {
    setThemeConfig((prev) => ({
      ...prev,
      typography: {
        ...prev.typography,
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 3, border: '1px solid #E5E7EB' }}>
          ...
          >
            ...
            <Button
              ...
              aria-label="Manage saved themes"
            >
        ...
        <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 3, border: '1px solid #E5E7EB' }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Fine-tune colors, typography, and other design elements to match your preferences.
          </Typography>
            ...
            <Box sx={{ 
              ...
              <Stack spacing={2}>
                ...
                <Typography variant="body1">
                  Body 1: This is the primary body text that will be used throughout your application.
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Body 2: This is the secondary body text for less emphasized content.
                </Typography>
        ...
        <Dialog open={showThemesList} onClose={() => setShowThemesList(false)} maxWidth="sm" fullWidth>
              ...
              <List>
                {userThemes.map((theme) => (
                  <ListItem key={theme.id}>
                    ...
                    />
                    <ListItemSecondaryAction>
                      <IconButton edge="end" onClick={() => handleEditTheme(theme)} title="Edit">
                        <EditIcon />
                      </IconButton>
                      {theme.isActive ? (
                        ...
                        <>
                          <IconButton edge="end" onClick={() => handleActivateTheme(theme.id)} title="Activate">
                            <CheckCircleIcon />
                          </IconButton>
                          <IconButton edge="end" onClick={() => handleDeleteTheme(theme.id)} title="Delete">
                            <DeleteIcon />
                          </IconButton>
                        </>
                      )}
          ...
          <DialogActions>
            <Button onClick={() => setShowThemesList(false)} sx={{ textTransform: 'none', fontWeight: 600 }}>
              Close
            </Button>
          </DialogActions>
        </Dialog>
...
export default UnifiedThemeEditorPage;
