(()=>{Object.assign||Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:function(e,a){if(null==e)throw new TypeError("Cannot convert first argument to object");for(var t=Object(e),o=1;o<arguments.length;o++){var s=arguments[o];if(null!=s)for(var r=Object.keys(Object(s)),n=0,c=r.length;n<c;n++){var i=r[n],l=Object.getOwnPropertyDescriptor(s,i);void 0!==l&&l.enumerable&&(t[i]=s[i])}}return t}});var se=window.ZohoDeskAsapInit&&window.ZohoDeskAsapInit()||{},re="zohohc-asap-web-app-main";window.ZohoHCAsapSettings={},ZohoDeskAsap.fileLoader,ZohoDeskAsap.Install=function(){var r,e,L,a,t,o,s,n,c,i,l,_,h,d,$,p,b,u,m,f,v,g,w,j,M,T,B,P,A,C,H,y,k,I,Z,x,O,z,F,U,G,K,N,D,V,q,W,J,Q,Y,X,ee,E;function S(e,a,t){for(var o=0,s=e.length;o<s;o++){var r,n=e[o];n&&((r=document.createElement("link")).rel=t,a&&(r.as=a),r.crossorigin="anonymous",r.href=n,r.className="zohohc-asap-web-resources",b&&r.setAttribute("nonce",b),"font"==a&&(r.type="font/woff2",r.setAttribute("crossorigin",!0)),p.appendChild(r))}}function R(o,s,r,n){return new Promise(function(e,a){var t=document.createElement(o);Object.keys(s).forEach(e=>{t[e]=s[e]}),t.setAttribute("crossorigin","anonymous"),r&&t.setAttribute("nonce",r),t.onerror=function(e){a(e,t)},t.onload=t.onreadystatechange=function(){this.readyState&&"complete"!=this.readyState||e()},n.appendChild(t)})}function ae(){D().addEventListener("click",V)}function te(){var e=N(),a=e.iconUrl||"";return`
                        ...
                        #${re}{
                            ${(e=function(e){return A+"size"+e})(60)}: 60px;
                        ...
                        .${y}button:focus-visible {
                            outline : var(${e(1)}) solid var(${A}clickable_areas);
                        }
                        ${s} #${re}${s} .${y}right, 
                        ${s} #${re}${o} .${y}right,
                        .${y}left{ 
                        ...
                        ${s} .${y}right.${y}rhombus,
                        ${o} .${y}right.${y}rhombus {
                            right : calc(var(${A}side_space) + var(${e(5)})); 
                            left: auto
                        }
                        ${s} .${y}left.${y}rhombus,
                        ${o} .${y}left.${y}rhombus {
                            left : calc(var(${A}side_space) + var(${e(5)})); 
                            right: auto
                        }
                        .${y}round, .${y}speech__bubble, .${y}square,
                        ${o} .${y}round, ${o} .${y}speech__bubble, ${o} .${y}square, 
                        [dir=rtl] .${y}round, [dir=rtl] .${y}speech__bubble, [dir=rtl] .${y}square {
                            ${a=`animation: launched var(${A}transition3) cubic-bezier(0.4, 0, 1, 1) both;`}
                            -o-${a}
                            -moz-${a}
                            -webkit-${a}
                        }
                        @${a=`keyframes launched {from { opacity: .8;transform: ${t}(var(${e(70)})) scale(.5);}to {opacity: 1;transform: ${t}(0) scale(1)}}`}
                        @-o-${a}
                        @-moz-${a}
                        @-webkit-${a}
                        ...
                        .${y}button:hover {
                            box-shadow: 0 0 var(${e(6)}) var(${e(1)}) var(${A}launcher_shadow);
                            outline: none;
                        ...
                        .${y}speech__bubble,
                        ${s} #${re}${s} .${y}left.${y}speech__bubble, 
                        ${s} #${re}${o} .${y}left.${y}speech__bubble,
                        .${y}right.${y}speech__bubble {
                            border-radius: var(${e(34)}) var(${e(34)}) var(${e(8)}) var(${e(34)})
                        }
                        .${y}left.${y}speech__bubble,
                        ${s} #${re}${s} .${y}right.${y}speech__bubble, 
                        ${s} #${re}${o} .${y}right.${y}speech__bubble {
                            border-radius: var(${e(34)}) var(${e(34)}) var(${e(34)}) var(${e(8)})
                        }
                        .${y}square {
                            border-radius: var(${e(15)})
                        }
                        ${o} .${y}rhombus, .${y}rhombus {
                            ${a=`animation: rhombuslaunched var(${A}transition3) cubic-bezier(0.4, 0, 1, 1) both;`}
                            -o-${a}
                            -moz-${a}
                            -webkit-${a}
                            border-radius: 30%;
                        ...
                        @${a=`keyframes rhombuslaunched {0% { opacity: .8;transform: ${t}(var(${e(70)})) rotate(0deg) scale(.5);}100% {opacity: 1;transform: ${t}(0) rotate(45deg) scale(1)}}`}
                        @-moz-${a}
                        @-webkit-${a}
                        @-o-${a}
                        ...
                        .${y}open__app .${y}launcher__icon {
                            ${t=`animation : openApp  var(${A}transition3) both cubic-bezier(0.4, 0, 1, 1);`}
                            -webkit-${t}
                            -o-${t}
                            -moz-${t}
                        }

                        @${a="keyframes openApp { 0% { transform: rotate(0); opacity: 0.8} 100% { transform: rotate(90deg); opacity :1 } }"}
                        @-o-${a} 
                        @-moz-${a}
                        @-webkit-${a}
            
                        .${y}close__app .${y}launcher__icon{
                            ${t=`animation : closeApp var(${A}transition3) ease-out both;`}
                            -o-${t}
                            -webkit-${t}
                            -moz-${t}
                        }

                        @${a="keyframes closeApp {0% { transform: scale(0.5); opacity: 0.8}100% {transform: scale(1);opacity: 1}}"}
                        @-o-${a}
                        @-moz-${a}
                        @-webkit-${a}
                        ...
                        .${y}rhombus.${y}image_blur::before {
                            ...
                            width: calc(var(${A}percentage100) + var(${e(12)}));
                            height: calc(var(${A}percentage100) + var(${e(12)}));
                        }
                        .${y}loding {
                            position: relative;
                            width: var(${e(8)});
                          ...
                          @media only screen and (max-device-width : 767px) {
                            ...
                            .${y}right.${y}rhombus {
                                right : var(${e(15)})!important; 
                                ${t="left : auto!important"}
                            }
                            ${s} #${re}${s} .${y}right.${y}rhombus, 
                            ${s} #${re}${o} .${y}right.${y}rhombus {
                                left : var(${e(15)})!important; 
                            ...
                            ${s} #${re}${s} .${y}left.${y}rhombus, 
                            ${s} #${re}${o} .${y}left.${y}rhombus {
                                right : var(${e(15)})!important; 
                                ${t}
                            }
                        ...
                        .${I}${o} .${y}button .${y}launcher__icon, 
                        .${I}${s} .${y}button .${y}launcher__icon {
                            animation-duration: unset !important
                        }
                        .${I}${o} .${y}right, 
                        .${I}${s} .${y}right {
                            right : var(${e(20)})!important;
                            ${t}
                        }
                        .${I}${o} .${y}left, 
                        .${I}${s} .${y}left {
                            left : var(${e(20)})!important;
                            ${a}
                        }
                        .${I}${o} .${y}right, 
                        .${I}${s} .${y}right {
                        ...
                        .${I}${o} .${y}right.${y}rhombus, 
                        .${I}${s} .${y}right.${y}rhombus {
                            right : var(${e(25)})!important;
                            ${t}
                        }
                        .${I}${o} .${y}left.${y}rhombus, 
                        .${I}${s} .${y}left.${y}rhombus {
                            left : var(${e(25)})!important;
                            ${a}
                        }
                        @media only screen and (max-width: 420px) {
                            .${I}${o} .${y}left, 
                            .${I}${s} .${y}left {
                                left : var(${e(8)})!important;
                                ${a}
                            }
                            .${I}${o} .${y}right, 
                            .${I}${s} .${y}right {
                                right : var(${e(8)})!important;
                                ${t}
                            }
                            .${I}${o} .${y}left, 
                            .${I}${s} .${y}left {
                        ...
                        @media only screen and (max-device-width : 767px) {
                            #${re} {
                                --zohohc_asap_web_side_space: var(${e(10)});
                            }
                        }
                        ...
                        @media only screen and (max-width : 767px)  and  (orientation: portrait) {
                            #${re} {
                                --zohohc_asap_web_side_space: var(${e(10)});
                                --zohohc_asap_web_bottom_space: var(${e(10)});
                            }
                        }
                        </style>`)),t=r._preferences.isHelpCenterPublic,o=r.privacySettings||{},s=o.web?o.web.clientId:"",(t||!t&&s)&&(B=setTimeout(O,(()=>F()?0:void 0===se.dynamicTimer?5e3:se.dynamicTimer)())),ae(),!F()&&U()||z(!1)},bindEvents:ae,getElement:te,getAppearenceCss:X=function(){var e,a="",t=K()||{},o=N()||{},t=t.themeColor,s=o.iconUrl||"",r=o.sideSpacing,n=o.bottomSpacing,o=o.position;return t&&(e=oe(t).text_color,a+=`.data-theme-asap-launcher-custom{
